...
class npy_data_loader(file_data_loader):
    ...
    def __init__(self, data_dir, prefix, mode, word_vec_npy='vec.npy', shuffle=True, max_length=60, batch_size=128):
...
class json_file_data_loader(file_data_loader):
    ...
    def __init__(self, file_name, word_vec_file_name, rel2id_file_name, mode, shuffle=True, max_length=60, case_sensitive=False, reprocess=False, batch_size=128):
        '''
