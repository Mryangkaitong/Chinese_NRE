...
def word_position_embedding(word, word_vec_mat, pos1, pos2, var_scope=None, word_embedding_dim=300, pos_embedding_dim=5, max_length=120, add_unk_and_blank=True):
